...
air_quality_corr = round(cor(air[c('PM2.5','PM10','SO2','NO2','CO','O3')]), 2)
...
```{r}
# Heatmap for O3 against weather variables
# Select relevant columns
selected_cols <- c("O3", "TEMP", "PRES", "DEWP", "RAIN", "WSPM")
cor_data <- air %>%
...
ggplot(cor_data, aes(x = Var1, y = Var2, fill = value, label = round(value, 2))) +
  geom_tile() +
  geom_text(color = "black", size = 3) +  # Add correlations on heatmap
  labs(title = "Correlation Heatmap of O3 Levels Against Weather Predictors") +
